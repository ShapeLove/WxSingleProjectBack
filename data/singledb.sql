...
CREATE TABLE `attention_info`  (
  ...
  `ext` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '冗余字段',
...
CREATE TABLE `user_info`  (
  ...
  `education` tinyint(4) NOT NULL COMMENT '学历枚举',
  `sex` tinyint(1) NOT NULL COMMENT '性别枚举',
  `province` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '籍贯省地址',
  `city` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '籍贯市地址',
  ...
  `work_area` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '工作地区',
  ...
  `photos` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '个人图片',
  `department` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '部门信息',
  ...
  `dongdong` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '咚咚号',
  `wx_number` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '微信号',
  `create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `modified` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '修改时间',
